...
# Count used to aggregate the counts of tags
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            subject = '{} ({}) recommends you reading "{}"'.format(cd['name'], sender, post.title)
